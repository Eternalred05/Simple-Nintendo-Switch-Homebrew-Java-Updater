...
public class AppsManagement {
    ...
    public static ArrayList<NxApp> addCafeApps() {
        ...
        apps.add(new NxApp("ftpiiu_plugin", "https://github.com/wiiu-env/ftpiiu_plugin"));
        ...
        apps.add(new NxApp("StyleMiiU-Plugin", "https://github.com/Themiify-hb/StyleMiiU-Plugin"));
        ...
        apps.add(new NxApp("Padcon-Plugin-Mod", "https://github.com/WiiDatabase/Padcon-Plugin-Mod"));
        apps.add(new NxApp("DRC-Sensorbar", "https://github.com/WiiDatabase/DRC-Sensorbar"));
    ...
    public static ArrayList<NxApp> addDolphinApps() {
        ...
        apps.add(new NxApp("Nintendont", "https://github.com/Eternalred05/Nintendont"));
