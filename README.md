...
# How to add new apps
You can add them directly in Logic.AppsManagement with NxApp Constructor, only the repo's name and url is needed, since it checks the rest of the info from github releases page.
# Required Dependencies
For building/running this program at least is required the following dependencies:
- Java Development Kit 23 (JDK 23)
- Jackson Core, Annotations, databinds and datatypes 1.28.3 for JSON management, be aware that usign other versions may cause version dependant errors
